...
class DetectionModel(BaseModel):
    ...
    def __init__(self, cfg="yolov5s_C3_ECA.yaml", ch=3, nc=None, anchors=None):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--cfg", type=str, default="yolov5s_C3_ECA.yaml", help="model.yaml")
